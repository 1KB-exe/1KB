...
_Import:
	...
	pop		eax
	push	dword [eax+10h]	; Preserve ProcessParameters for 1KB.exe.
...
_MaxNameLengthPtrP:
	...
	test	eax, eax
	jnz		short DLLLoop
	pop		ebx					; Nonvolatile ProcessParameters contract.

_HashShiftPtr		equ _HashShiftPtrP-1
_MaxNameLengthPtr	equ _MaxNameLengthPtrP-1
_HashMultiplierPtr	equ _HashMultiplierPtrP-1
