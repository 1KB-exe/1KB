; ALTERED Crinkler source for 1KB.exe. This is not the upstream header.
; See README.md and LICENSE.txt in this directory.
bits		32
extern	_PackedData
...
global  _ResourceRVAPtr
global  _ResourceSizePtr
...
AritDecodeLoop:
	...
	dw		120					; Size of optional header
_CharacteristicsPtr:
...
; Patched by 1KB.exe after inserting the resource carrier at offset 148.
; Keeping each trampoline on a DWORD boundary also leaves reasonable loader
; stack/heap allocation values for the small optimized icons accepted here.
NoMatchJump:
	jmp near ResourceNoMatch
	db 0, 1, 0
AritDecode2Jump:
	jmp near _AritDecode2
	db 0, 1, 0, 0, 0, 0, 0
